...
import styles from './GadgetsMenuStyle'
...
export class GadgetsMenuList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isClicked: false,
    ...
    renderHeaderContainer = () => {
        return (
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.mainText}>Gadget Menu</Text>
...
export default GadgetsMenuList
