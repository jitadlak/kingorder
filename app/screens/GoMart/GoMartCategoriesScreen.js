...
import styles from './GoMartCategoriesStyle'
...
export class GoMartCategoriesScreen extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isClicked: false,
    ...
    renderHeaderContainer = () => {
        return (
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.mainText}>Grocery Store</Text>
    ...
    renderItemCellContainer = (item) => {
        return (
            <TouchableOpacity style={styles.productCell} onPress={() => this.props.navigation.navigate("ProductDetail", { fav: item.isFav ? IMG_CONST.heartActive : IMG_CONST.heartDeactive, item: item })}>
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        getMartCategoryByNameList: (data, successCallBack, failureCallBack) => dispatch(homeActions.getMartCategoryByNameList(data, successCallBack, failureCallBack)),
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(GoMartCategoriesScreen)
